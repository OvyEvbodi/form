import IDBankVerificationForm from "@/components/PaymentDetailsIDUploadForm";
import Link from "next/link";

const IDBankVerificationPage = () => {
...
export default IDBankVerificationPage;
