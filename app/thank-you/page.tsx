...
const ThankYou = () => {
  return (
    <div className="flex justify-center items-center p-4 font-medium text-medium min-h-screen min-w-screen">
      ...
      <div className="p-10 md:p-20 bg-cyan-700 text-white text-base sm:text-lg text-center">You have successfully completed the process. <br />Further steps will be communicated to you shortly.</div>
      </div>
    </div>
  )
};
