      ...
      <form name="iev" className="p-4" action={action}>
        <div id="personal info" >
          ...
          <div className="p-2 mb-4">
            ...
            <div onClick={handleChooseFile} className="bg-cyan-800 max-w-max py-2 px-8 text-white font-semibold hover:bg-gray-700">You must click here to upload ID card selected (max: 4MB)<span className="text-red-700">&#10038;</span></div>
